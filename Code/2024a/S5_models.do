...
mi estimate, cmdok or level(99.5) dots: melogit f1ccsmkdaily peersmk peerdissmk peerecig peerdisecig i.zzwave ccalcyr c_age ///
b_sex b_cbclextn b_cbcladn b_cbclspn b_cbclwdn ///
singlep b_pardem b_parres b_parcon b_parrel b_parmon b_parborn b_famposi b_famconf i.b_parempl i.b_seifa i.b_hinc if zzwave>=3 || zzC_ID:
...
mi estimate, cmdok or level(99.5) dots: melogit f1ccecigdaily peersmk peerdissmk peerecig peerdisecig i.zzwave ccalcyr c_age ///
b_sex b_cbclextn b_cbcladn b_cbclspn b_cbclwdn ///
singlep b_pardem b_parres b_parcon b_parrel b_parmon b_parborn b_famposi b_famconf i.b_parempl i.b_seifa i.b_hinc if zzwave>=3 || zzC_ID:
