...
use "D:\UNSW\APSALS - Documents\Papers\PIP43. Role of peers on smoking and ecigarette use\Data\imputed-mice.dta", clear
...
merge m:1 zzC_ID zzwave using "D:\UNSW\APSALS - Documents\Papers\PIP43. Role of peers on smoking and ecigarette use\Data\Missing cases.dta", keep(match master) nogen
drop if miss==0
drop miss
...
save "D:\UNSW\APSALS - Documents\Papers\PIP43. Role of peers on smoking and ecigarette use\Data\final analysis data.dta", replace
