...
set.seed(464896,kind="L'Ecuyer-CMRG")
...
parallel::clusterEvalQ(cl, Lvars <- "b_pardem + b_parres + b_parcon + b_parrel + b_parborn + b_parempl + b_famposi + b_famconf + b_seifa + b_hinc + c_age1 + b_sex + hhavguse1 + parmon1 + homeacc1 + alcrules1 + alcmoney1 + singlep1 + smoking1 + cbclextn1 + cbcladn1 + cbclwdn1 + peeruse1 + peerdis1 + othsup1 + hhavguse2 + parmon2 + homeacc2 + alcrules2 + alcmoney2 + singlep2 + smoking2 + cbclextn2 + cbcladn2 + cbclwdn2 + peeruse2 + peerdis2 + othsup2 + hhavguse3 + parmon3 + homeacc3 + alcrules3 + alcmoney3 + singlep3 + smoking3 + cbclextn3 + cbcladn3 + cbclwdn3 + peeruse3 + peerdis3 + othsup3 + hhavguse4 + parmon4 + homeacc4 + alcrules4 + alcmoney4 + singlep4 + smoking4 + cbclextn4 + cbcladn4 + cbclwdn4 + peeruse4 + peerdis4 + othsup4 + hhavguse5 + parmon5 + homeacc5 + alcrules5 + alcmoney5 + singlep5 + smoking5 + cbclextn5 + cbcladn5 + cbclwdn5 + peeruse5 + peerdis5 + othsup5")
parallel::clusterEvalQ(cl, Bvars <- "b_pardem + b_parres + b_parcon + b_parrel + b_parborn + b_parempl + b_famposi + b_famconf + b_seifa + b_hinc + c_age1 + b_sex + hhavguse1 + parmon1 + homeacc1 + alcrules1 + alcmoney1 + singlep1 + smoking1 + cbclextn1 + cbcladn1 + cbclwdn1 + peeruse1 + peerdis1 + othsup1")
...
save(glmresultsa,file=paste0(cloudstor,"PhD/Paper 5 - APSALs application/Results/glmresultsa 20191028.RData"))
save(glmresultsb,file=paste0(cloudstor,"PhD/Paper 5 - APSALs application/Results/glmresultsb 20191028.RData"))