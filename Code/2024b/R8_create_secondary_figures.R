...
anyhed_res <- readRDS(paste0(workdir,"Results/Raw/Secondary anyhed_res 20240501.rds"))
anyhed_res$age2 <- ifelse(anyhed_res$age-anyhed_res$init<=3,anyhed_res$age-anyhed_res$init,NA)
anyhed_res <- anyhed_res[which(anyhed_res$init>11),]
...
harms_res <- readRDS(paste0(workdir,"Results/Raw/Secondary harms_res 20240501.rds"))
harms_res$age2 <- ifelse(harms_res$age-harms_res$init<=3,harms_res$age-harms_res$init,NA)
harms_res <- harms_res[which(harms_res$init>11),]
...
anyharms_res <- readRDS(paste0(workdir,"Results/Raw/Secondary anyharms_res 20240501.rds"))
anyharms_res$age2 <- ifelse(anyharms_res$age-anyharms_res$init<=3,anyharms_res$age-anyharms_res$init,NA)
anyharms_res <- anyharms_res[which(anyharms_res$init>11),]
...
depend_res <- readRDS(paste0(workdir,"Results/Raw/Secondary depend_res 20240501.rds"))
depend_res$age2 <- ifelse(depend_res$age-depend_res$init<=3,depend_res$age-depend_res$init,NA)
depend_res <- depend_res[which(depend_res$init>11),]
...
abuse_res <- readRDS(paste0(workdir,"Results/Raw/Secondary abuse_res 20240501.rds"))
abuse_res$age2 <- ifelse(abuse_res$age-abuse_res$init<=3,abuse_res$age-abuse_res$init,NA)
abuse_res <- abuse_res[which(abuse_res$init>11),]
...
aud_res <- readRDS(paste0(workdir,"Results/Raw/Secondary aud_res 20240501.rds"))
aud_res$age2 <- ifelse(aud_res$age-aud_res$init<=3,aud_res$age-aud_res$init,NA)
aud_res <- aud_res[which(aud_res$init>11),]
...
ggsave(plot = fig1,
       filename = paste0(workdir,"Results/F3 Secondary analysis 20240501.tiff"),
       width = 16,
       height = 20,
       units = "cm")
ggsave(plot = fig2,
       filename = paste0(workdir,"Results/F4 Secondary analysis 20240501.tiff"),
       width = 16,
       height = 20,
       units = "cm")
...
ggsave(plot = alcfq_fig1,
       filename = paste0(workdir,"Results/SE1 alcfq1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = alcfq_fig2,
       filename = paste0(workdir,"Results/SE2 alcfq2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = hed_fig1,
       filename = paste0(workdir,"Results/SE3 hed1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = hed_fig2,
       filename = paste0(workdir,"Results/SE4 hed2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = harms_fig1,
       filename = paste0(workdir,"Results/SE5 harms1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = harms_fig2,
       filename = paste0(workdir,"Results/SE6 harms2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = depend_fig1,
       filename = paste0(workdir,"Results/SE7 depend1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = depend_fig2,
       filename = paste0(workdir,"Results/SE8 depend2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = abuse_fig1,
       filename = paste0(workdir,"Results/SE9 abuse1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = abuse_fig2,
       filename = paste0(workdir,"Results/SE10 abuse2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = aud_fig1,
       filename = paste0(workdir,"Results/SE11 aud1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = aud_fig2,
       filename = paste0(workdir,"Results/SE12 aud2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = anyhed_fig1,
       filename = paste0(workdir,"Results/SF5 anyhed1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = anyhed_fig2,
       filename = paste0(workdir,"Results/SF6 anyhed2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
...
ggsave(plot = anyharms_fig1,
       filename = paste0(workdir,"Results/SF7 anyharms1 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")
ggsave(plot = anyharms_fig2,
       filename = paste0(workdir,"Results/SF8 anyharms2 20240501.tiff"),
       width = 16,
       height = 10,
       units = "cm")